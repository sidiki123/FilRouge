                  ...
                  <tbody>
                      @foreach(Cart::content() as $event)
                        <tr>
                            ...
                            <form action="{{route('cart.destroy',$event->rowId)}}" method="post">
                              @csrf
                              @method('DELETE')
                                  <button href="#" class="text-dark"><i class="fa fa-trash"></i></button></td>
                            </form>
          ...
          <div class="row py-5 p-4 bg-white rounded shadow-sm">
            ...
            <div class="col-lg-6">
              ...
              <div class="p-4">
                ...
                </ul><a href="{{route('caisse.index')}}" class="btn btn-primary rounded-pill py-2 btn-block">Passer à la caisse</a>
              </div>
            </div>
</div>
    @else
