@include('Admin/vali-admin-master/docs/inc.header')
    ...
    <script src="{{asset('admin_assets/js/plugins/jquery.vmap.min.js')}}"></script>
    <!-- <script type="text/javascript" src="js/plugins/jquery.vmap.world.js"></script> -->
    <script src="{{asset('admin_assets/js/plugins/jquery.vmap.world.js')}}"></script>
    <!-- <script type="text/javascript" src="js/plugins/jquery.vmap.sampledata.js"></script> -->
    <script src="{{asset('admin_assets/js/plugins/jquery.vmap.sampledata.js')}}"></script>
